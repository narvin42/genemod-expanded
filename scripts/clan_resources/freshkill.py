...
class Nutrition:
    ...
    def current_score(self, value) -> None:
        ...
        text_config = PREY_CONFIG["text_nutrition"]
...
class FreshkillPile:
    ...
    def __init__(self, pile: dict = None) -> None:
        ...
        if pile:
            ...
            self.pile = {
                "expires_in_4": PREY_CONFIG["start_amount"],
                "expires_in_3": 0,
                "expires_in_2": 0,
                "expires_in_1": 0,
            }
            self.total_amount = PREY_CONFIG["start_amount"]
...
ADDITIONAL_PREY = PREY_CONFIG["additional_prey"]
PREY_REQUIREMENT = PREY_CONFIG["prey_requirement"]
CONDITION_INCREASE = PREY_CONFIG["condition_increase"]
FEEDING_ORDER = PREY_CONFIG["feeding_order"]
HUNTER_BONUS = PREY_CONFIG["hunter_bonus"]
HUNTER_EXP_BONUS = PREY_CONFIG["hunter_exp_bonus"]
FRESHKILL_EVENT_TRIGGER_FACTOR = PREY_CONFIG["base_event_trigger_factor"]
MAL_PERCENTAGE = PREY_CONFIG["nutrition_malnourished_percentage"]
STARV_PERCENTAGE = PREY_CONFIG["nutrition_starving_percentage"]

FRESHKILL_ACTIVE = PREY_CONFIG["activate_death"]
FRESHKILL_EVENT_ACTIVE = PREY_CONFIG["activate_events"]
